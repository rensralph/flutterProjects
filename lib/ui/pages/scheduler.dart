...
import 'package:base/ui/views/WeekView.dart';


class SchedulerPage extends StatefulWidget {
  static User theUser = new User();
  SchedulerPage({Key key, this.title}) : super(key: key);
  final String title;
  @override
...
class _SecondRouteState extends State<SecondRoute> {
  ...
  void createTask() async {
    ...
    times.add(timeStart);
    times.add(timeEnd);
    SchedulerPage.theUser.createTask(this.taskName, this.days, times, this.repeats);
