...
import 'package:base/task/Task.dart';
import 'package:base/task/Occurrence.dart';
import 'package:base/User/User.dart';
...
class _MyWeekViewState extends State<MyWeekView> {
  ...
  void createAllTaskData() {
    User myUser = SchedulerPage.theUser;
...
class _DayViewState extends State<DayView> {
  ...
  List<Widget> makeTaskList() {
    ...
    for (Task task in SchedulerPage.theUser.tasks) {
      for (Occurrence occurs in task.occurrence) {
  ...
  void deleteATask(String taskName) {
    List<Task> taskList = SchedulerPage.theUser.tasks;
    for (Task task in taskList) {
      if (task.name == taskName) {
        task.removeOccurrenceByDay(day);
      }
    }
    SchedulerPage.theUser.tasks = taskList;
  }
